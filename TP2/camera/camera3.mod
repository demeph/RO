...
# données numériques dont le début est indiqué par le mot-cl� "data;"
...
data;
	...
	param coeffcontr default 1; #tous les valeurs sont initialis�es � 1(de (1,*) � (10,*));

	param mdroite default 1:= 4 2; #tous les valeurs sont inialis�es � 1 sauf 4eme qui egale � 1
